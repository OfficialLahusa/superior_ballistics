...
public class AnimatedCannonBlockRenderer extends GeoBlockRenderer<AnimatedCannonBlockEntity> {
    ...
    protected final Identifier LOG_TEXTURE = new Identifier("minecraft", "textures/block/spruce_log.png");
    protected final Identifier PLANKS_TEXTURE = new Identifier("minecraft", "textures/block/spruce_planks.png");
